...
from python.bleu import Bleu
from python.rouge import RougeL
...
if __name__ == '__main__':
    ...
    # test_score8()
    # test_score5()
    data = [{'ref_answer': '1200', 'cand_answer': '法哈娜'}, {'ref_answer': '马拉维', 'cand_answer': '法哈娜'}, {'ref_answer': '马巫德', 'cand_answer': ' 法哈娜'}, {'ref_answer': '13', 'cand_answer': '法哈娜'}]
