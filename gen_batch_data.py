...
from model.llh_slqa import SLQA
...
def train(args):
    ...
    for epoch in range(args.epoch_num):
        ...
        for batch_id, (article, question, answer_span, _) in enumerate(db.train_loader):
            ...
            pickle.dump((article_elmo, question_elmo), open("./elmo/"+str(batch_id)+".pkl", "wb"))
            print("./elmo/"+str(batch_id)+".pkl")
            continue
            train_idx += question.size()[0]
            # continue

            p1, p2 = model(article, question, article_elmo, question_elmo)
        ...
        if args.with_valid:
            ...
            for article, question, _ in db.valid_loader:
                ...
                p1, p2 = model(article, question, article_elmo, question_elmo, is_training=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--epoch-num", type=int, default=15)
